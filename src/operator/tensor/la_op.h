...
//    std::cout<<"INPUT1 ";
//    for ( int i = 0; i < ndim; ++i ) std::cout<<(*in_attrs)[0][i]<<"  ";
//    std::cout<<std::endl;
//    std::cout<<"INPUT2 ";
//    for ( int i = 0; i < ndim; ++i ) std::cout<<(*in_attrs)[1][i]<<"  ";
//    std::cout<<std::endl;
...
//    std::cout<<"OUTPUT ";
//    for ( int i = 0; i < ndim; ++i ) std::cout<<oshape[i]<<"  ";
//    std::cout<<std::endl;
...
mshadow::Tensor<xpu, dim, DType> LaOpFlatten(const TBlob& blob, mshadow::Stream<xpu> *s, int axis = -2) {
  if (axis < 0) {
    axis = blob.ndim() + axis;
  }
  if (axis >= blob.ndim()-2) {
